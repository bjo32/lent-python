...
def test_1f():
    ...
    s_good = DummyStation("Good", "River X", (1.0, 2.0))
    
    s_bad_logic = DummyStation("Bad Logic", "River X", (2.0, 1.0))  # Inconsistent station
    
    # Inconsistent station with None data
    s_bad_none = DummyStation("Bad None", "River X", None)
    
    # Partial None
    s_bad_partial = DummyStation("Bad Partial", "River X", (1.0, None))
